...
if __name__ == '__main__':
    ...
    POOL = '0x000dd0b1528a396c6ea2e09796a7b4a534e9e37b'

    pass

    c = Client('ckey_1dcbb4def6f5447493e30f100ea')
    b = c.xyk_service.get_transactions_for_exchange("eth-mainnet", "uniswap_v2", POOL)
    if not b.error:
        print(b.data)
    else:
